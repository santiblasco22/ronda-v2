...
/**
 * Publicar sin fotos es válido: Storage puede estar deshabilitado (plan
 * Spark) y la publicación tiene que poder crearse igual.
 */
export const MIN_LISTING_PHOTOS = 0;

export const FREE_ACCOUNT_LISTING_CAP = 15;
...
export const MAX_PRO_REQUEST_MESSAGE_LENGTH = 500;
